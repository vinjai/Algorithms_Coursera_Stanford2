...
def calculateWeightedCompleteTime(jobs):
    ...
    jobs.sort(key=lambda v:(v['weight']-v['length'],v['weight']),reverse=True)
...
if __name__=="__main__":
    jobList=readAsListOfDict('_642c2ce8f3abe387bdff636d708cdb26_jobs.txt',
                             '\s+',2,['weight','length'],[int,int],1)
    writeSingleToFile("Problem1a.txt",calculateWeightedCompleteTime(jobList))
    pass